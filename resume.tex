...
\section{Research Experience}
  ...
  {Dartmouth College}{Hanover, NH, USA}
  \itemListStart
  \myItem{Design, implement, and debug embedded systems across the hardware-software stack in C, C++, Python, and Verilog, building real-time wireless systems on software-defined radio platforms.}
...
\pubListStart
\justifying
\item \textbf{Cesar Arguello}, Beatrice Perez, Timothy J. Pierson, and David Kotz. NICPrint: Wi-Fi NIC Identification via Malformed Preambles. \textit{Proceedings of the Network and Distributed System Security Symposium (NDSS)}, 2027. Accepted for Publication
...
\item \emph{Software}: Microsoft Suite, Git, GDB, Wireshark, GNURadio, Vivado \\
